...
namespace c{
    ...
    /// </summary>
    public class VisMac2HiRes : MarshalByRefObject, IPlugin, IPlugin_Visualizer {
        // IPlugin
        public string Identifier {
            get { return "Apple II Hi-Res rev Graphic Visualizer"; }
        }
        ...
        private const string VIS_GEN_BITMAP = "apple2-hi-res-bitmap-rev";
        private const string VIS_GEN_BITMAP_GRID = "apple2-hi-res-bitmap-grid-rev";
        ...
        private VisDescr[] mDescriptors = new VisDescr[] {
            new VisDescr(VIS_GEN_BITMAP, "Apple II Hi-Res Bitmap Rev", VisDescr.VisType.Bitmap,
                new VisParamDescr[] {
            ...
            new VisDescr(VIS_GEN_BITMAP_GRID, "Apple II Hi-Res Rev Sprite Sheet", VisDescr.VisType.Bitmap,
                new VisParamDescr[] {
                    new VisParamDescr("File offset (hex)",
                        P_OFFSET, typeof(int), 0, 0x00ffffff, VisParamDescr.SpecialMode.Offset, 0),
